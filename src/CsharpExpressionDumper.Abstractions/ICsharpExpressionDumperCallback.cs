...
{
    Action<object?, Type?, StringBuilder, int> ProcessRecursiveCallbackDelegate { get; }
    ...
    void Initialize(Action<object?, Type?, StringBuilder, int> processRecursiveCallbackDelegate, StringBuilder builder);
}
